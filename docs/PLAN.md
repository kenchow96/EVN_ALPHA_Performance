...
| 7v — Autonomous Validation (perfection) | In Progress — **Run 0x2609044E Complete**: DR-robust prop9_accel06 gains (kp_pos=2.0e-4, kp_vel=1.0e-5, endpoint_kp=2.5e-6, accel_scale=0.60) with start_duty_POS=0.90 on axes 2/3. Results: 2/16 cases 12/12 (axis 0 NEG repeat 0, axis 3 NEG repeat 0), 16/16 traces. Axis 2 POS stiction fix WORKED: start_duty 0.80→0.90 achieved 11/12 on case_09/11. EV3 Large axis 0 case_12 (NEG repeat 0) 12/12, axis 1 case_14 (NEG repeat 2) 11/12. Core 1: PERFECT — 999-1001µs period, 0 missed ticks. Next: Commit all updates, update docs/PLAN.md Status Board and this index.md, then consider next tuning priorities (e.g. per-axis gains for EV3 Large axis 1). | 2026-09-09 | `uncommitted` |
