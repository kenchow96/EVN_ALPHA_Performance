...
| 7 — Motion engine | 🟠 Audit repair HITL in progress — Core 1 direct SRAM timer, anti-windup, 5 ms observer cadence, 25 kHz PWM, 12-gate metrics, and fresh battery preflight are verified. CDC sweeping is retired. Autonomous UF2 extraction verified three complete 530-row, fresh-battery, zero-miss Medium traces; case 4 exposed hardware-alarm loss after repeated active-loop flash lockouts. The build now explicitly pauses/re-arms the alarm around coasted lockout transactions and resumes at case 4. Follow [ASSUMPTIONS.md](ASSUMPTIONS.md). **Phase 8 remains blocked** until all four motors pass the battery-gated profile suite and beat baseline. | 2026-09-02 | `909ac01`, `58c368c`, `9b7a3e8` + timer fix |
