...
| A4 | Battery **reads ~0.8–1% low**. Data points: loaded 7.12 V vs meter 7.18 V; **no-load 7.257 V** (meter TBD). Offset vs drift TBD | `hal_battery.c` | Two measurements so far | Track across charge cycles; calibrate constant in Phase 9 | ⚠️ monitor (action item) |
